        ...
        if (employees == null) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    employees.add(theEmployee = new Employee(rs.getString(1),rs.getString(2),rs.getString(3), rs.getDate(4), rs.getInt(5), rs.getString(6)));
                    UserAccess.getInstance().add(theEmployee);
                }
